...
def test_yone_fullbody_card_sync_is_default_reachable_and_minimal() -> None:
    ...
    # The old 0.5.1 layout override is intentionally disabled. The installed
    # game keeps its native icon canvas, while the default Yone extension
    # applies the audited top-88 crop and assignment baseline at render time.
